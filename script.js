     ...
     function showConsultations() {
          ...
          objectStore.openCursor().onsuccess = function(e) {
               ...
               if(cursor) {
                   ...
                   const cancelBtn = document.createElement('button');
                    cancelBtn.classList.add('btn', 'btn-link');
                    cancelBtn.innerHTML = '';
                 ...
                 consultations.appendChild(ConsultationHTML);
                    ...
                    if(!consultations.firstChild) {
                        services.textContent = 'Appointment Waiting List';
                      ...
                      consultations.appendChild(noSchedule);
                        ...
                        services.textContent = '  Waiting List For Fever '
                    }
               }
          }
     }
          ...
          transaction.oncomplete = () => {
               ...
               if(!consultations.firstChild) {
                    ...
                    services.textContent = 'No Patients in the Waiting List';
